...
export default class GetSudoku {
    ...
    private static FAKESUDOKU: any = {
        currentSudokuNumbers:[2,5,8,7,4,3,9,6,1,6,7,1,5,9,8,2,3,4,3,4,9,2,1,6,8,7,5,5,6,
    ...
    /**
     * Return a fake object with sudoku numbers in it.
     * @returns {*}
     * @memberof GetSudoku
     */
    public getSudoku():any {
        let result = new Promise(resolve=>{
            resolve(GetSudoku.FAKESUDOKU)
        })
        return result;
    };
}